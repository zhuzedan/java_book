public class OverLoading_3_7 {
    public void max(int a, int b) {// 含有两个int类型参数的方法
        System.out.println(a > b ? a : b);
    }

    public void max(double a, double b) {// 含有两个double类型参数的方法
        System.out.println(a > b ? a : b);
    }
    ...
    public static void main(String[] args) {
        OverLoading_3_7 ol = new OverLoading_3_7();
